...
fun `markdownToHtml`(`markdown`: String): String {
    return FfiConverterString.lift(
        rustCall { _status ->
            _UniFFILib.INSTANCE.uniffi_beautyxt_rs_fn_func_markdown_to_html(
