...
fun StartupScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.oldtyxt_welcome),
        ...
        FilledTonalButton(
            ...
            Text(stringResource(R.string.oldtyxt_open))
            FileTypeSelectionDialog(
                ...
                FilledTonalButton(
                    ...
                    Text(text = stringResource(R.string.oldtyxt_txt))
                }
                FilledTonalButton(
                    modifier = Modifier.fillMaxWidth(),
                    onClick = {
                ...
                if (preferencesUiState.experimentalFeatureOpenAnyFileType.second.value) {
                    FilledTonalButton(
                        ...
                        Text(text = stringResource(R.string.oldtyxt_any))
                    }
                }
            }
        }
        FilledTonalButton(
            ...
            Spacer(modifier = modifier.width(8.dp))
            Text(stringResource(R.string.oldtyxt_create))
            FileTypeSelectionDialog(
