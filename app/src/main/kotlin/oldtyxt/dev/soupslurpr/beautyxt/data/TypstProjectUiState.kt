package oldtyxt.dev.soupslurpr.beautyxt.data
...
data class TypstProjectUiState(
    ...
    /** Source diagnostics */
    val sourceDiagnostics: MutableCollection<oldtyxt.uniffi.beautyxt_rs_typst_bindings.TypstCustomSourceDiagnostic> = mutableStateListOf(),
)