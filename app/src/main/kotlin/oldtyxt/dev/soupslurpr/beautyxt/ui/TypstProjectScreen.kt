    ...
    if (isPortrait) {
        Column(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.oldtyxt_rendered_typst_project_preview),
...
fun WarningsAndErrors(
    modifier: Modifier = Modifier,
    sourceDiagnostics: List<oldtyxt.uniffi.beautyxt_rs_typst_bindings.TypstCustomSourceDiagnostic>,
) {
    Column(
        modifier = modifier
    ) {
